<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ptbr" lang="ptbr">
	...
	<body id="bodyKaraoke" style="color: white;background: url('{$app_url}images/karaoke_bg.gif')">
		...
		<div class="row m-0">
			...
			<div class="col-8">
				<div class="row">
					<div class="col-12 center" style="padding: 30px 0px 15px 0px">
					...
					<div class="col-12 center">
						<h4>Volume: <span id="volumeSpan">100%</span></h4>
					</div>
					<div id="pausedDiv" class="col-12 center" style="display: none">
						<h3>VÍDEO PAUSADO!</h3>
					</div>
				</div>
			</div>
