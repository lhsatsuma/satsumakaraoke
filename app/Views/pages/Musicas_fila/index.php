...
<table class="table table-responsive-xl table-striped table-list">
	<thead>
		<tr>
			...
			<th scope="col" class="pointer d-none d-lg-table-cell" data-head-field="data_criacao" onclick="OrderByFiltro('data_criacao')">Data Criação <span class="icon-order-by"></span></th>
		</tr>
	</thead>
	<tbody>
		{if empty($records)}
