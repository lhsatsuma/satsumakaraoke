...
<form id="EditarForm" method="post" action="{$app_url}usuarios/salvarmyInfo">
	...
	<div class="row">
		<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
			<label for="senha_atual">{translate f="Users" l="LBL_CURRENT_PASSWORD"}</label>
	...
	<div class="row">
		<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
			<label for="senha_nova">{translate f="Users" l="LBL_NEW_PASSWORD"}</label>
		...
		<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
			<label for="confirm_senha_nova">{translate f="Users" l="LBL_CONFIRM_NEW_PASSWORD"}</label>
	...
	<div class="row">
		<div class="col-12">
			...
			<button type="button" class="btn btn-outline-primary btn-rounded margin-5" onclick="resetPreferences()"><i class="fas fa-undo"></i> {translate f="Users" l="LBL_RESET_PREFERENCES"}</button>
		</div>
	</div>
</form>
